# Super Engine Stable
**Please note, this isn't the latest version of the mod, the mod's latest unstable updates can be found on the [actions page](https://github.com/superpowers04/Super-Engine/actions), [the unstabe branch](https://github.com/superpowers04/Super-Engine/tree/nightly), [at nightly.link](https://nightly.link/superpowers04/Super-Engine/workflows/main/nightly) or on the [Discord server](https://discord.gg/28GPGTRuuR). If you want a stable engine however, 0.10.0 is more stable however 0.10.0 is less polished and has far less features**

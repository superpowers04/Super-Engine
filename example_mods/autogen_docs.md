...
# PlayState.hx
  ...
  1234: callInterp("startTimerStep",[swagCounter]);
  1277: callInterp("startTimerStepAfter",[swagCounter]);
  1355: callInterp("startSong",[]);
  1515: callInterp("generateNotes",[]);
  1602: callInterp("generateNotesAfter",[unspawnNotes]);
  1625: callInterp("generateSongBefore",[]);
  1627: callInterp("generateSong",[unspawnNotes]);
  1673: callInterp("strumNoteLoad",[babyArrow,player == 1]);
  1715: callInterp("strumNoteAdd",[babyArrow,player == 1]);
  1746: callInterp('addKeyEventListeners',[]);
  1908: callInterp("update",[elapsed]);
  2048: callInterp("updateAfter",[elapsed]);
  2074: callInterp('noteSpawn',[dunceNote]);
  2088: callInterp("draw",[]);
  2091: callInterp("drawAfter",[]);
  2144: callInterp("endSong",[]);
  2251: callInterp('spawnNoteSplash',[a]);
  2366: callInterp('popUpScore',[rating,scoreObjs,currentTimingShown]);
  2555: callInterp("holdShit",[holdArray]);
  2573: callInterp("susHit",[daNote]);
  2589: callInterp("holdShitAfter",[holdArray]);
  2601: callInterp('registerKeys',[SEIKeyMap]);
  2618: callInterp('registerKeysAfter',[SEIKeyMap]);
  2633: callInterp('keyPress',[event.keyCode]);
  2645: callInterp('keyShit',[pressArray,holdArray]);
  2706: callInterp('keyShitAfter',[pressArray,holdArray,hitArray]);
  2725: callInterp('keyRelease',[event.keyCode]);
  2759: callInterp('botKeyShit',[]);
  2779: callInterp("susHit",[daNote]);
  2834: callInterp("keyShit",[pressArray,holdArray]);
  2856: callInterp("susHit",[daNote]);
  2900: callInterp("keyShitAfter",[pressArray,holdArray,hitArray]);
  2927: callInterp("beforeNoteHit",[playerCharacter,note]);
  2944: callInterp("noteHit",[playerCharacter,note]);
  3006: callInterp("miss",[player,direction,calcStats]);
  3007: callInterp('miss',[direction,calcStats]);
  3015: callInterp("noteMiss",[player,daNote,direction,calcStats]);
  3016: callInterp('noteMiss',[daNote,direction,calcStats]);
  3034: callInterp("stepHit",[]);
  3086: callInterp("sectionChange",[curSection]);
  3089: callInterp("stepHitAfter",[]);
  3097: callInterp('restartSong',[]);
  3148: callInterp('restartSongAfter',[]);
  3164: callInterp('reload',[false]);
  3165: callInterp('unload',[]);
  3182: callInterp('reloadDone',[]);
  3189: callInterp("beatHit",[]);
  3246: callInterp("beatHitAfter",[]);
  3291: callInterp("destroy",[]);
# OptionsMenu.hx

...
# PlayState.hx
  ...
  2084: callInterp("draw",[]);
  2089: callInterp("drawAfter",[]);
  2167: callInterp("endSong",[]);
  2274: callInterp('spawnNoteSplash',[a]);
  2389: callInterp('popUpScore',[rating,scoreObjs,currentTimingShown]);
  2578: callInterp("holdShit",[holdArray]);
  2596: callInterp("susHit",[daNote]);
  2612: callInterp("holdShitAfter",[holdArray]);
  2624: callInterp('registerKeys',[SEIKeyMap]);
  2641: callInterp('registerKeysAfter',[SEIKeyMap]);
  2656: callInterp('keyPress',[event.keyCode]);
  2668: callInterp('keyShit',[pressArray,holdArray]);
  2729: callInterp('keyShitAfter',[pressArray,holdArray,hitArray]);
  2748: callInterp('keyRelease',[event.keyCode]);
  2782: callInterp('botKeyShit',[]);
  2802: callInterp("susHit",[daNote]);
  2857: callInterp("keyShit",[pressArray,holdArray]);
  2879: callInterp("susHit",[daNote]);
  2923: callInterp("keyShitAfter",[pressArray,holdArray,hitArray]);
  2950: callInterp("beforeNoteHit",[playerCharacter,note]);
  2967: callInterp("noteHit",[playerCharacter,note]);
  3029: callInterp("miss",[player,direction,calcStats]);
  3030: callInterp('miss',[direction,calcStats]);
  3038: callInterp("noteMiss",[player,daNote,direction,calcStats]);
  3039: callInterp('noteMiss',[daNote,direction,calcStats]);
  3057: callInterp("stepHit",[]);
  3109: callInterp("sectionChange",[curSection]);
  3112: callInterp("stepHitAfter",[]);
  3120: callInterp('restartSong',[]);
  3175: callInterp('restartSongAfter',[]);
  3187: callInterp('reload',[false]);
  3188: callInterp('unload',[]);
  3205: callInterp('reloadDone',[]);
  3212: callInterp("beatHit",[]);
  3269: callInterp("beatHitAfter",[]);
  3314: callInterp("destroy",[]);
# OptionsMenu.hx
   622: callInterp("initScript",[],id);
...
# Note.hx
   ...
   363: callInterp("noteCreate",[this,rawNote]); 
   417: callInterp("noteAdd",[this,rawNote]);
   453: callInterp('noteDestroy',[this]);
   490: callInterp("noteUpdate",[this]);
   513: callInterp("noteUpdateAfter",[this]);
   518: callInterp("noteHitDad",[dad,this]);
# NoteSplash.hx

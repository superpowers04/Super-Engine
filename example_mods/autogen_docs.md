...
# PlayState.hx
  ...
  1518: callInterp("generateNotes",[]);
  1605: callInterp("generateNotesAfter",[unspawnNotes]);
  1628: callInterp("generateSongBefore",[]);
  1630: callInterp("generateSong",[unspawnNotes]);
  1676: callInterp("strumNoteLoad",[babyArrow,player == 1]);
  1718: callInterp("strumNoteAdd",[babyArrow,player == 1]);
  1749: callInterp('addKeyEventListeners',[]);
  1911: callInterp("update",[elapsed]);
  2051: callInterp("updateAfter",[elapsed]);
  2077: callInterp('noteSpawn',[dunceNote]);
  2091: callInterp("draw",[]);
  2094: callInterp("drawAfter",[]);
  2147: callInterp("endSong",[]);
  2254: callInterp('spawnNoteSplash',[a]);
  2369: callInterp('popUpScore',[rating,scoreObjs,currentTimingShown]);
  2558: callInterp("holdShit",[holdArray]);
  2576: callInterp("susHit",[daNote]);
  2592: callInterp("holdShitAfter",[holdArray]);
  2604: callInterp('registerKeys',[SEIKeyMap]);
  2621: callInterp('registerKeysAfter',[SEIKeyMap]);
  2636: callInterp('keyPress',[event.keyCode]);
  2648: callInterp('keyShit',[pressArray,holdArray]);
  2709: callInterp('keyShitAfter',[pressArray,holdArray,hitArray]);
  2728: callInterp('keyRelease',[event.keyCode]);
  2762: callInterp('botKeyShit',[]);
  2782: callInterp("susHit",[daNote]);
  2837: callInterp("keyShit",[pressArray,holdArray]);
  2859: callInterp("susHit",[daNote]);
  2903: callInterp("keyShitAfter",[pressArray,holdArray,hitArray]);
  2930: callInterp("beforeNoteHit",[playerCharacter,note]);
  2947: callInterp("noteHit",[playerCharacter,note]);
  3009: callInterp("miss",[player,direction,calcStats]);
  3010: callInterp('miss',[direction,calcStats]);
  3018: callInterp("noteMiss",[player,daNote,direction,calcStats]);
  3019: callInterp('noteMiss',[daNote,direction,calcStats]);
  3037: callInterp("stepHit",[]);
  3089: callInterp("sectionChange",[curSection]);
  3092: callInterp("stepHitAfter",[]);
  3100: callInterp('restartSong',[]);
  3158: callInterp('restartSongAfter',[]);
  3174: callInterp('reload',[false]);
  3175: callInterp('unload',[]);
  3192: callInterp('reloadDone',[]);
